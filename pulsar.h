...
#include <TFT_eSPI.h>
#include "animation_utils.h" // For exit animation optimization
...
void drawPulsar()
{
    ...
    unsigned long currentTime = getAnimationTime(); // Use frozen time during exit animation
